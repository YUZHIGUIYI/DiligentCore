...
static Uint32 GetQueryDataSize(QUERY_TYPE QueryType)
{
    ...
    switch (QueryType)
    {
        ...
        case QUERY_TYPE_PIPELINE_STATISTICS:
            return (WGPUPipelineStatisticName_ComputeShaderInvocations + 1) * sizeof(Uint64);
        default:
...
QueryManagerWebGPU::QueryManagerWebGPU(RenderDeviceWebGPUImpl* pRenderDeviceWebGPU, const Uint32 QueryHeapSizes[])
{
    ...
    for (Uint32 QueryTypeIdx = QUERY_TYPE_UNDEFINED + 1; QueryTypeIdx < QUERY_TYPE_NUM_TYPES; ++QueryTypeIdx)
    {
        ...
        std::vector<WGPUPipelineStatisticName> wgpuPipelineStatisticNames{
        ...
        if (QueryType == QUERY_TYPE_PIPELINE_STATISTICS)
        {
            wgpuQuerySetDesc.pipelineStatistics      = wgpuPipelineStatisticNames.data();
            wgpuQuerySetDesc.pipelineStatisticsCount = static_cast<Uint32>(wgpuPipelineStatisticNames.size());
        }
...
QUERY_TYPE QueryManagerWebGPU::QuerySetInfo::GetType() const { return m_Type; }

Uint32 QueryManagerWebGPU::QuerySetInfo::GetQueryCount() const { return m_QueryCount; }

WGPUQuerySet QueryManagerWebGPU::QuerySetInfo::GetWebGPUQuerySet() const { return m_wgpuQuerySet.Get(); }

Uint32 QueryManagerWebGPU::QuerySetInfo::GetMaxAllocatedQueries() const { return m_MaxAllocatedQueries; }

bool QueryManagerWebGPU::QuerySetInfo::IsNull() const { return m_wgpuQuerySet.Get() == nullptr; }
