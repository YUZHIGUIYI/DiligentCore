...
static const INTERFACE_ID IID_SwapChainWebGPU =
...
#    define ISwapChainWebGPU_GetWebGPUSwapChain(This)  CALL_IFACE_METHOD(SwapChainWebGPU, GetWebGPUSwapChain, This)
