...
class QueryWebGPUImpl final : public QueryBase<EngineWebGPUImplTraits>
{
public:
    using TQueryBase = QueryBase<EngineWebGPUImplTraits>;

    QueryWebGPUImpl(IReferenceCounters*     pRefCounters,
