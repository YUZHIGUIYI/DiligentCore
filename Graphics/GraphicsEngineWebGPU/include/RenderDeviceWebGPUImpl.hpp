...
public:
    ...
    WGPUInstance DILIGENT_CALL_TYPE GetWebGPUInstance() const override { return m_wgpuInstance.Get(); }

    /// Implementation of IRenderDeviceWebGPU::GetWebGPUAdapter() in WebGPU backend.
    WGPUAdapter DILIGENT_CALL_TYPE GetWebGPUAdapter() const override { return m_wgpuAdapter.Get(); }

    /// Implementation of IRenderDeviceWebGPU::GetWebGPUDevice() in WebGPU backend.
    WGPUDevice DILIGENT_CALL_TYPE GetWebGPUDevice() const override { return m_wgpuDevice.Get(); }
