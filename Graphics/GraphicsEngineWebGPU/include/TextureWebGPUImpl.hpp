...
public:
    ...
    /// Implementation of ITexture::QueryInterface().
    ...
    Uint64 DILIGENT_CALL_TYPE GetNativeHandle() override { return reinterpret_cast<Uint64>(GetWebGPUTexture()); }

    /// Implementation of ITextureWebGPU::GetWebGPUTexture() in WebGPU backend.
    WGPUTexture DILIGENT_CALL_TYPE GetWebGPUTexture() const override { return m_wgpuTexture.Get(); }

    WGPUBuffer GetWebGPUStagingBuffer() const { return m_wgpuStagingBuffer.Get(); }
...
private:
    void DILIGENT_CALL_TYPE CreateViewInternal(const TextureViewDesc& ViewDesc,
                                               ITextureView**         ppView,
